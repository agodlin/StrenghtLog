...
public class BodyWeightContent {
    ...
    private static void addItem(BodyWeightItem item) {
        ITEMS.add(item);
        ITEM_MAP.put(item.id, item);
    }

    private static BodyWeightItem createDummyItem(int position) {
        return new BodyWeightItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
